...
% in my case 
end_effector = dh_matrix(0,     0,     0,  theta_1)...
             * dh_matrix(20,    0,     0,  theta_2)...
             * dh_matrix(20,    0,     0,  theta_3)...
             * dh_matrix(5,     0,     0,  theta_4);

% Calculate the Jacobian of the system
ik_jacobian = [diff(end_effector(1,4),theta_1),diff(end_effector(1,4),theta_2),diff(end_effector(1,4),theta_3),diff(end_effector(1,4),theta_4);
...
f_ik_jacobian = symfun(ik_jacobian, [theta_1 theta_2 theta_3 theta_4]);
...
while (error>0.1)
    ...
    ik_jacobian_ans = f_ik_jacobian(q(1),q(2),q(3),q(4));
    
    inv_ik_jacobian = pinv(ik_jacobian_ans);
    dq=inv_ik_jacobian*(delta(1:3,4));
    ...
    % effector
    e_c = dh_matrix(0,    0,   0,  q(1))...
        * dh_matrix(20,   0,   0,  q(2))...
        * dh_matrix(20,   0,   0,  q(3))...
        * dh_matrix(5,    0,   0,  q(3));
